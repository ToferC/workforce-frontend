...
add-pay-rate-help = Use the civilian form for occupational groups and the military form for ranks. Rates are never edited in place: adding one with a later effective date supersedes the current rate from that date on.
add-civilian-rate = Civilian classification
add-military-rate = Military rank
select-a-group = Select a group
select-a-rank = Select a rank
level-help = Level within the group, e.g. 4 for AS-04.
annual-rate = Annual rate ($)
annual-rate-help = Annual salary in dollars, e.g. 95,000.
effective-date = Effective date
effective-date-help = The rate applies to salary costs from this date forward.
cost-heading = Cost
